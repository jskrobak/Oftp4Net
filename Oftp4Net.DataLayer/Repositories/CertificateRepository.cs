...
{
    public async Task<DataFragment<Certificate>> GetFragmentAsync(CertificateFilter filter,
        GridDataProviderRequest<Certificate> request,
        CancellationToken cancellationToken = default)
    {
        ...
        var data = await filtered.ApplyGridDataProviderRequest<Certificate>(request)
